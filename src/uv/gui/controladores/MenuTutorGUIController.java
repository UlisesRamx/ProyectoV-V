...
public class MenuTutorGUIController implements Initializable {
    ...
    @FXML
    private void abrirModificarProblematicas(ActionEvent event) throws IOException, SQLException {
        Stage stageMenuJefe = new Stage();
        FXMLLoader loader = new FXMLLoader();
        Parent root = loader.load(getClass().getResource("/uv/gui/interfaces/CU07ConsultarProblematicas.fxml").openStream());
        CU07ConsultarProblematicasController  cu07ConsultarProblematicasController = (CU07ConsultarProblematicasController) loader.getController();
